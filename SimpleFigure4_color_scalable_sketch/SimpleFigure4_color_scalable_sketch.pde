...
{
  size(1000, 744);
  Tom = new SimpleFigure(width/2-50,height/2, color( 0,128,0 ) );
  Dick = new SimpleFigure(width/2,height/2, color( 0, 255, 128));
  Harry = new SimpleFigure(width/2+50,height/2, color( 0, 128, 255 ));
